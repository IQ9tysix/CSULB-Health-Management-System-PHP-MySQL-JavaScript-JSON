     ...
     // output data of each row
        ...
        echo "</table><br>";
		 if($_SESSION['save']=='save')
		 {
		   ...
		   $sql_view= "create view uni_health_db.".$selected_text." as ".$sql;
		   echo $sql_view;
		   ...
		   $sql_create= "insert into view_criteria values('".$selected_text.",'".$selected_criteria."')";
