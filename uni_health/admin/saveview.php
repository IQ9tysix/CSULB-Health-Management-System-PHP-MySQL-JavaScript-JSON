...
if(isset($_POST['save']))
{
	...
	$viewsql = "create view " . $viewname . " as " . $query ;
	
	$mysqli->query($viewsql);
	$insertsql= "insert into criteria_groups values('".$viewname."','".$criteria."')";
	$mysqli->query($insertsql);
	echo "<h5> View " . $viewname . " Created </h5>";
	
	$result = $mysqli->query($query);
	if ($result->num_rows > 0) 
	{
     echo "<br><h5> Contents of the view are: </h5>";
