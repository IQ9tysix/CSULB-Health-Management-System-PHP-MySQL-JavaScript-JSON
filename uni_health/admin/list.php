...
if ($mysqli->connect_error)
  ...
  $sql = "SELECT * FROM appscheduler_bookings where appointment_d= curdate()+1";
  $sql_1="SELECT * FROM appscheduler_bookings WHERE appointment_d= curdate()+2";
   $result = $mysqli->query($sql);
	$result1= $mysqli->query($sql_1);
   echo "<h5> List of Students whose appointments scheduled for tomorrow</h5>";
   if ($result->num_rows > 0) 
	...
	echo "<h5> List of Students whose appointments scheduled for day after tomorrow</h5>";
